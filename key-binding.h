...
enum bind_action {
    ...
    BIND_ACTION_QUICK_LAUNCH_1,
    BIND_ACTION_QUICK_LAUNCH_2,
    BIND_ACTION_QUICK_LAUNCH_3,
    BIND_ACTION_QUICK_LAUNCH_4,
    BIND_ACTION_QUICK_LAUNCH_5,
    BIND_ACTION_QUICK_LAUNCH_6,
    BIND_ACTION_QUICK_LAUNCH_7,
    BIND_ACTION_QUICK_LAUNCH_8,
    BIND_ACTION_QUICK_LAUNCH_9,
